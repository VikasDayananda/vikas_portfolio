...
class About_me extends React.Component{
    render()
    {
        return(
            ...
            <P>My name is Vikas Dayananda,a graduate student at <a  target="_blank" href="https://www.uncc.edu">The University of North Caroloina, Charlotte (UNCC) </a>
            ...
            <a href="https://drive.google.com/file/d/0B-M-QIiacJ27VE5CZjhVUnRTTmc/view?usp=sharing">
                <Button className="button button1" >View Resume</Button>
            </a>
            <a href="https://drive.google.com/a/uncc.edu/uc?authuser=2&id=0B-M-QIiacJ27VE5CZjhVUnRTTmc&export=download" download="VikasDayanandaResume">
